...
import { getMissingQuestionsReport, processOfflineQueue } from '@/lib/dataLayer';
    ...
    <div className="space-y-10">
      <header className="study-header">
        <h2 className="text-xl font-semibold text-foreground">
          {questionnaireConfig.steps[2]?.title || 'Definitief indienen'}
        </h2>
        <p className="text-muted-foreground mt-1">
          {questionnaireConfig.steps[2]?.description || 'Deel uw algehele ervaring en eventuele aanbevelingen.'}
        </p>
      </header>

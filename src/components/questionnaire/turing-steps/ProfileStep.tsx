...
import { isProfileComplete } from '@/lib/dataLayerTuring';
    ...
    <div>
      <header className="study-header">
        <h2 className="text-xl font-semibold text-foreground">
          {turingQuestionnaireConfig.steps[0].title}
        </h2>
        <p className="text-muted-foreground mt-1">
          {turingQuestionnaireConfig.steps[0].description}
        </p>
      ...
      <div className="question-group">
        <QuestionGroup
          questions={turingQuestionnaireConfig.profile_questions}

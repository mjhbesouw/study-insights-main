...
import { isPatientComplete } from '@/lib/dataLayerTuring';
...
const SegmentationStep = ({
  ...
  const patients = turingQuestionnaireConfig.segmentation_patients;
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-2">
                  <span
                    className={`text-xs px-3 py-1.5 rounded-full border shadow-sm flex items-center gap-1.5 ${allComplete
  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      {/* Variant Tabs removed for Turing Test */}
